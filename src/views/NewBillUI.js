  ...
  return (`
    <div class='layout'>
      ...
      <div class='content'>
        ...
        <div class='content-title' data-testid="new-bill"> Envoyer une note de frais </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <div class="error error-imageFormat" data-testid="error-img">Le document doit être au format jpg, jpeg ou png</div>
                  </div>
                </div>
            </div>
            <div class="row">
